...
export const apiService = {
  ...
  challenges: {
    ...
    linkToGoal: (id, goalId) =>
      api.post(`/challenges/${id}/link-goal`, { goalId }),
  ...
  // AI methods
  ai: {
    // Story 3.1, 3.2: Generate challenge using AI
    generateChallenge: (params) => api.post('/ai/generateChallenge', params),

    // Story 3.4, 3.5: Submit work for AI feedback
    submitForFeedback: (submissionText, challengeContext, submissionId) =>
      api.post('/ai/submitForFeedback', {
        submissionText,
        challengeContext,
        submissionId,
      }),
