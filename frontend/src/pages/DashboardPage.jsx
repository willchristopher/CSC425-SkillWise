...
const ICON_PATHS = {
  ...
  target: [{ cx: 12, cy: 12, r: 10 }, { cx: 12, cy: 12, r: 6 }, { cx: 12, cy: 12, r: 2 }],
  trend: ['M23 6 13.5 15.5 8.5 10.5 1 18', 'M17 6 23 6 23 12'],
  calendar: [],
  checkCircle: ['M22 11.08V12a10 10 0 1 1-5.93-9.14', 'M22 4 12 14.01 9 11.01'],
  zap: ['M13 2 3 14 12 14 11 22 21 10 12 10 13 2'],
  star: [{ cx: 12, cy: 8, r: 7 }, 'M8.21 13.89 7 23 12 20 17 23 15.79 13.88'],
  award: [{ cx: 12, cy: 8, r: 7 }, 'M8.21 13.89 7 23 12 20 17 23 15.79 13.88'],
  users: ['M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2', { cx: 9, cy: 7, r: 4 }, 'M23 21v-2a4 4 0 0 0-3-3.87', 'M16 3.13a4 4 0 0 1 0 7.75'],
  activity: ['M22 12 18 12 15 21 9 3 6 12 2 12'],
  'ai-tutor': ['M4 4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H4z', 'M9 9a3 3 0 1 1 6 0 3 3 0 0 1-6 0z', 'M9 1v4', 'M15 1v4', 'M9 20v4', 'M15 20v4', 'M1 9h4', 'M1 15h4', 'M20 9h4', 'M20 15h4'],
  plus: ['M12 5v14M5 12h14'],
};

const QUICK_ACTIONS_ICONS = {
  'AI Tutor': { paths: [['<rect x="4" y="4" width="16" height="16" rx="2" ry="2"/>', '<rect x="9" y="9" width="6" height="6"/>', '<line x1="9" y1="1" x2="9" y2="4"/>', '<line x1="15" y1="1" x2="15" y2="4"/>', '<line x1="9" y1="20" x2="9" y2="23"/>', '<line x1="15" y1="20" x2="15" y2="23"/>', '<line x1="20" y1="9" x2="23" y2="9"/>', '<line x1="20" y1="14" x2="23" y2="14"/>', '<line x1="1" y1="9" x2="4" y2="9"/>', '<line x1="1" y1="14" x2="4" y2="14"/>']], viewBox: '0 0 24 24', iconClass: 'icon-bg-indigo' },
  'Create Goal': { paths: [[{ cx: 12, cy: 12, r: 10 }, 'M12 8v8M8 12h8']], viewBox: '0 0 24 24', iconClass: 'icon-bg-blue' },
  'Start Challenge': { paths: [['<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>']], viewBox: '0 0 24 24', iconClass: 'icon-bg-purple' },
  'Peer Review': { paths: [['M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2', { cx: 9, cy: 7, r: 4 }, 'M23 21v-2a4 4 0 0 0-3-3.87', 'M16 3.13a4 4 0 0 1 0 7.75']], viewBox: '0 0 24 24', iconClass: 'icon-bg-pink' },
  'Leaderboard': { paths: [['M6 9H4.5a2.5 2.5 0 0 1 0-5H6', 'M18 9h1.5a2.5 2.5 0 0 0 0-5H18', 'M4 22h16', 'M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22', 'M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22', 'M18 2H6v7a6 6 0 0 0 12 0V2Z']], viewBox: '0 0 24 24', iconClass: 'icon-bg-yellow' },
};

const CalendarIcon = () => <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>;
const TrophyIcon = () => <SVGIcon paths={ICON_PATHS.trophy} />;
const FlameIcon = () => <SVGIcon paths={ICON_PATHS.flame} />;
const TargetIcon = () => <SVGIcon paths={ICON_PATHS.target} />;
const TrendUpIcon = () => <SVGIcon paths={ICON_PATHS.trend} />;
const CheckCircleIcon = () => <SVGIcon paths={ICON_PATHS.checkCircle} />;
const ZapIcon = () => <SVGIcon paths={ICON_PATHS.zap} />;
...
const DashboardPage = () => {
  ...
  const formatEventType = (type) => {
    const types = { challenge_started: 'Started a Challenge', challenge_completed: 'Completed a Challenge', goal_created: 'Created a Goal', goal_completed: 'Achieved a Goal', review_submitted: 'Submitted a Review', points_earned: 'Earned Points', streak_milestone: 'Streak Milestone' };
    return types[type] || 'Activity';
  };

  const getEventIcon = (type) => {
    const icons = { challenge_started: 'zap', challenge_completed: 'check-circle', goal_created: 'target', goal_completed: 'award', review_submitted: 'users', points_earned: 'star', streak_milestone: 'flame' };
  ...
  // NOTE: statCards array is kept for reference but not currently used in the component
  // The stat cards are hardcoded in the JSX below
  const statCards = [
    { label: 'Active Goals', value: stats.activeGoals, iconClass: 'icon-bg-blue', link: '/goals', iconName: 'target' },
    { label: 'Challenges Done', value: stats.completedChallenges, iconClass: 'icon-bg-purple', link: '/challenges', iconName: 'zap' },
    { label: 'Points Earned', value: stats.totalPoints, iconClass: 'icon-bg-yellow', link: '/leaderboard', iconName: 'award' },
    { label: 'Progress', value: `${stats.progressPercent}%`, iconClass: 'icon-bg-green', link: '/progress', iconName: 'trend' },
  ];

  const quickActions = [
    { title: 'AI Tutor', description: 'Get instant feedback on your work', link: '/ai-tutor', iconClass: 'icon-bg-indigo', iconName: 'ai-tutor' },
    { title: 'Create Goal', description: 'Set new learning objectives', link: '/goals', iconClass: 'icon-bg-blue', iconName: 'target' },
    { title: 'Start Challenge', description: 'Practice and improve your skills', link: '/challenges', iconClass: 'icon-bg-purple', iconName: 'star' },
    { title: 'Peer Review', description: 'Review and learn from others', link: '/peer-review', iconClass: 'icon-bg-pink', iconName: 'users' },
    { title: 'Leaderboard', description: 'See how you rank', link: '/leaderboard', iconClass: 'icon-bg-yellow', iconName: 'trophy' },
  ];

  const getActivityIcon = (iconName) => <SVGIcon paths={ICON_PATHS[iconName] || ICON_PATHS.activity} size={18} />;
          ...
          <div className="dashboard-actions-grid animate-stagger-container">
            {quickActions.map((action, index) => (
              ...
              >
                ...
                >
                  <SVGIcon paths={ICON_PATHS[action.iconName] || ICON_PATHS.activity} size={24} />
                </div>
